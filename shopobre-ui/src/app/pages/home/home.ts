...
export class Home implements OnInit {
  ...
  private readonly sectionConfigs: HomeSectionConfig[] = [
    ...
    },
    {
      ...
      categoryMatch: 'Eletrônicos',
      limit: 7,
    },
    {
      id: 'casa',
      title: 'Casa e cozinha: escolhas do dia',
      categoryMatch: 'Casa',
      limit: 7,
    },
    {
      id: 'brinquedos-jogos',
      title: 'Brinquedos e jogos para se divertir',
      categoryMatch: 'Brinquedos e Jogos',
      limit: 7,
    },
    {
      id: 'moda',
      title: 'Moda em destaque',
      categoryMatch: 'Moda',
      limit: 7,
    },
    {
      ...
      categoryMatch: 'Beleza',
      limit: 7,
    },
    {
      id: 'mercado',
      title: 'Mercado: itens essenciais',
      categoryMatch: 'Mercado',
      limit: 7,
    },
  ];
